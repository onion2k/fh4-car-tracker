...
const cars = require("./cars_new.json");
const fh4cars = [];
const sndx = {};
const keys = [];
let n = 0;
...
const manualOldCars = {
    "2016 Alfa Romeo Giulia Quadrifoglio Forza Edition": "2016 Alfa Romeo Giulia Quadrifoglio Forza Edition",
    ...
    "2013 Audi R8 Coupe V10 plus 5.2 FSI quattro": "2013 Audi R8 Coupe V10 plus 5.2 FSI quattro",
    ...
    "1988 Chevrolet Monte Carlo Super Sport": "1988 Chevrolet Monte Carlo Super Sport",
    "1979 Chevrolet Camaro  [Gen 2.2] Z28": "1979 Chevrolet Camaro  [Gen 2.2] Z28",
    "1970 Chevrolet Camaro [Gen 2.1] Z28": "1970 Chevrolet Camaro [Gen 2.1] Z28",
    "1969 Chevrolet Camaro  [Gen 1] Super Sport Coupe": "1969 Chevrolet Camaro  [Gen 1] Super Sport Coupé",
    "2017 Ford Focus RS Preorder Car": "2017 Ford Focus RS",
    "1985 Ford RS200 Evolution": "1985 Ford RS200 Evolution",
    ...
    "2016 HSV Limited Edition Gen-F GTS Maloo": "2016 HSV Limited Edition Gen-F GTS Maloo",
    ...
    "1981 James Bond Citroen 2CV6 James Bond Edition": "1981 James Bond Edition Citroen 2CV6",
    "1977 James Bond Lotus Esprit S1 James Bond Edition": "1977 James Bond Edition Lotus Esprit S1",
    "1974 James Bond AMC Hornet James Bond Edition": "1974 James Bond Edition AMC Hornet",
    ...
    "2014 Lamborghini Huracan LP 610-4": "2014 Lamborghini Huracan LP 610-4",
    "2014 Lamborghini Urus": "2014 Lamborghini Urus",
    "2008 Lamborghini Reventon Forza Edition": "2008 Lamborghini Reventon Forza Edition",
    ...
    "2018 McLaren 720S": "2018 McLaren 720S",
    "2018 McLaren 720S Preorder Car": "2018 McLaren 720S",
    ...
    "1985 Porsche #185 959 Prodrive Rally Raid": "1985 Porsche #185 959 Prodrive Rally Raid",
    "2013 Renault Clio RS 200": "2013 Renault Clio RS 200",
    "2016 RJ Anderson #37 Polaris RZR-Rockstar Energy Pro 2 Truck": "2016 RJ Anderson #37 Polaris RZR-Rockstar Energy Pro 2 Truck",
    "2016 Spania GTA GTA Spano": "2016 Spania GTA GTA Spano",
...
cars.map((car)=>{
    ...
    if (keys.indexOf(car.Year+" "+car.Makes+" " +car.Models)===-1) {

        if (manualOldCars[car.Year+" "+car.Makes+" " +car.Models]) {
            oldcar = manualOldCars[car.Year+" "+car.Makes+" " +car.Models];
        } else {
            let s = sndx[car.Year+"-"+soundex(car.Year+" "+car.Makes+" " +car.Models, true)];
            if (s) { oldcar = s; } else {
                console.log("Lookup: ", car.Year+" "+car.Makes+" " +car.Models);
            }
        }
    }
